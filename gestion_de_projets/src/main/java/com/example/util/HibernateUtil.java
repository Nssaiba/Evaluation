    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                configuration.addAnnotatedClass(com.example.classes.Employe.class);
                configuration.addAnnotatedClass(com.example.classes.Projet.class);
                configuration.addAnnotatedClass(com.example.classes.Tache.class);
                configuration.addAnnotatedClass(com.example.classes.EmployeTache.class);
